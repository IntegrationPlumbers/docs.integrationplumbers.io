...
|---|---|
| Your Enterprise Manager version, 13.5 or 24ai | It decides which build you receive, 24.1.2.0.0 for 24ai or 13.5.16.0.0 for 13.5. Both carry the same features, so this changes nothing about what you can evaluate; it also tells us which console screens to point you at. |
