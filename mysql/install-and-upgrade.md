...
```
emcli deploy_plugin_on_server -plugin=ip.em.xmyb -sys_password=<repository SYS password>
emcli get_plugin_deployment_status -plugin=ip.em.xmyb
```
...
```
emcli deploy_plugin_on_agent -agent_names="agent-host.example.com:3872" -plugin=ip.em.xmyb
```
